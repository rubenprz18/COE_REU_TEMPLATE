...
\makeatother
    ...
    The \verb|\divider| command creates a horizontal rule that can be used to visually separate specific content.

    \divider

    The \verb|\section{}| command has a proprietary style that automatically generates concentric rings running off the left edge of the page, echoing the wavefront motif on the cover. Note that the section number is removed in the class configuration to maintain a cleaner appearance in the mini-summary. Speaking of the mini-summary, it has a fixed size so that the content recommended to be inside it is approximately 12 items. This means that the font size will decrease as more sections are added.
